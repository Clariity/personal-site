...
export function FooterColumn({ children }: ChildProps) {
  return <div className="my-4 w-full md:w-auto">{children}</div>;
}

export function FooterHeading({ children }: ChildProps) {
  return <h3 className="text-xl mb-3">{children}</h3>;
}

export function FooterSubHeading({ children }: ChildProps) {
  return <h4 className="text-lg my-2">{children}</h4>;
}

export function FooterLink({ link, text }: FooterLinkProps) {
  return (
    <div className="my-1 text-base font-light">
      <Link href={link}>
        <a className="inline-block hover:text-primary">{text}</a>
      </Link>
    </div>
  );
}

export function FooterExternalLink({ link, text }: FooterLinkProps) {
  return (
    <div className="my-1 text-base font-light">
      <Link href={link}>
        <a
...
export function FooterLinkedInLink() {
  return (
    ...
    >
      <svg
        className="fill-fg-secondary hover:fill-primary"
