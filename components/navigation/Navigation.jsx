...
export default function Navigation() {
  ...
  useEffect(() => {
    if (darkMode.value) {
      document.getElementById("toggle").classList.toggle("darkModeActive");
      document.getElementById("wave").classList.toggle("darkModeActive");
    }
  }, []);
  ...
  function handleToggle(toggle) {
    ...
    setTimeout(() => {
      toggle.classList.toggle("darkModeActive");
      document.getElementById("wave").classList.toggle("darkModeActive");
    }, 150);
  ...
  return (
    <div className="navigation row">
      ...
      <div className={`col-xs-8 text-align-right navigation-align`}>
        <span className="toggle" id="toggle" onClick={(e) => handleToggle(e.target)} size={80} />
        <button
        ...
        >
          <svg viewBox="0 0 250 250" className="github-corner-svg" aria-hidden="true">
            <path d="M0,0 L115,115 L130,115 L142,142 L250,250 L250,0 Z"></path>
            <path
              d="M128.3,109.0 C113.8,99.7 119.0,89.6 119.0,89.6 C122.0,82.7 120.5,78.6 120.5,78.6 C119.2,72.0 123.4,76.3 123.4,76.3 C127.3,80.9 125.5,87.3 125.5,87.3 C122.9,97.6 130.6,101.9 134.4,103.2"
              fill="currentColor"
              className="octo-arm github-corner-svg-path"
            ></path>
            <path
